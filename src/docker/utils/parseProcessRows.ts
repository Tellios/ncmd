...
export const parseProcessRows = (processRows: string[]): Array<Record<string, string | null>> => {
    ...
    dataRows.forEach(row => {
        ...
        const process = columnNames.reduce((process: Record<string, string | null>, columnName: string) => {
